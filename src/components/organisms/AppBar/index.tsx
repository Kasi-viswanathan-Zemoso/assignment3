  ...
  return (
    ...
    <Container maxWidth="lg">
      ...
      <Box sx={{ marginTop:2,display:"flex", justifyContent:"space-between", flexGrow:0.1}}>
        ...
        {/* <ButtonComponent variant={'text'} color={undefined} startIcon={''} endIcon={<KeyboardArrowDownIcon htmlColor='black' />} title={'Explore'} titleColor={'black'} buttonDeco={'none'} hoverColor={''} width={90} borderColor={''} onClick={() => handleOpen()} borderBottom={''} paddingBottom={''} paddingTop={''} backgroundColor={''}/> */}
        <Button
            sx={{
